...
public class App1Module : AbpModule
{
    ...
    private void ConfigureLocalization()
    {
        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                ...
                .AddVirtualJson("/Localization/App1");

            options.DefaultResourceType = typeof(App1Resource);
        ...
        {
            options.MapCodeNamespace("App1", typeof(App1Resource));
        });
    }
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<App1Module>();
            if (hostingEnvironment.IsDevelopment())
            {
                /* Using physical files in development, so we don't need to recompile on changes */
                options.FileSets.ReplaceEmbeddedByPhysical<App1Module>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    private void ConfigureNavigationServices()
    {
        ...
        {
            options.MenuContributors.Add(new App1MenuContributor());
        });
    }
    ...
    {
        context.Services.AddAutoMapperObjectMapper<App1Module>();
        Configure<AbpAutoMapperOptions>(options =>
        {
             ...
             */
            options.AddMaps<App1Module>(/* validate: true */);
        });
    }

    private void ConfigureEfCore(ServiceConfigurationContext context)
    {
        context.Services.AddAbpDbContext<App1DbContext>(options =>
        {
